...
export const Sidebar = ({ mobileOpen, setMobileOpen, isPinned, setIsPinned }) => {
    ...
    const handleCreateWorkspace = async (e) => {
        ...
        try {
            ...
            setWorkspaceError(err.response?.data?.message || err.message || "Failed to create workspace. Please try again.");
        } finally {
